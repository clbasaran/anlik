...
public actor CacheService {
    ...
    public func saveHistoryToCache(_ photos: [PhotoMetadata]) {
        ...
        do {
            ...
            AppLogger.service.error("Failed to save history cache: \(error.localizedDescription, privacy: .public)")
        }
    }
    ...
    public func loadHistoryFromCache() -> [PhotoMetadata] {
        ...
        do {
            ...
            AppLogger.service.error("Failed to load history cache: \(error.localizedDescription, privacy: .public)")
            return []
        }
    }
    ...
    public func downloadAndSaveForWidget(urlString: String, stripId: String, cityName: String?, lat: Double?, lon: Double?, thumbnailUrl: String? = nil) async {
        ...
        do {
            ...
            AppLogger.service.debug("Successfully saved photo to App Group for widget.")
        } catch {
            AppLogger.service.error("Failed to download and save for widget: \(error.localizedDescription, privacy: .public)")
        }
    }
    ...
    private func sendPhotoToWatch(_ photo: PhotoMetadata) async {
        ...
        do {
            ...
            AppLogger.service.error("Failed to send photo to watch: \(error.localizedDescription, privacy: .public)")
        }
    }
}
